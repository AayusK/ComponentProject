...
Through this project I think that I under software development significantly more. Building
a component from scratch, rather than just writing methods and learning about it, showed 
me how important design is and how to properly implement it. 

> Also, did the portfolio project surface any gaps in your own knowledge of
> software development. If so, what are those gaps and how did you address them?

One major gap was testing without a reference. I had to define what the expected behaviors were and check properties directly. I did this by writing smaller tests that focused on specific behaviors and properties.

> Finally, as a part of completing the portfolio project, to what extent has
> your perspective of software development changed, if at all? In other words,
> is software development something you still enjoy? If not, why not?

My perspective has shifted to appreciate the more "boring" parts of software development and documentation. I enjoy it more than I did than before, and maybe I wouldn't have switched to ECE. It's interesting seeing how the elements contribute to something bigger.
...
I picked up skills in, component based software design, JUnit testing strategies for custom data structures, refactoring and organizing code, and version control with git. 

> The follow-up question is: could you rephrase these skills you picked up
> as bullet points that you could put on a resume? Try it below.

- Designed and implemented "NebulaNest", a custom data structure in Java.
- Developed a comprehensive JUnit 4 test suite to verify component functionality and edge cases.
- Refactored code to adhere to package structures and industry standards.
- Created demonstration applications to showcase component capabilities in simulated scenarios.

> Next, how has working on this project affected your career trajectory?
> In other words, do you now hate the topic you picked? Or, are you even more
> interested in it? Both outcomes are valuable to your personal development.

This project has reinforced my interest in backend and systems development. Seeing a data structure come to life and controlling its internal logic is satisfying. It hasn't changed my trajectory but has made me more confident in pursuing roles that involve logic and managing data. 
...
To continue, I plan to learn more about build automation tools like Maven or Gradle to manage dependencies and testing more easier. I also want to explore CI/CD pipelines as mentioned in the assignment. I can reach out to my course instructors and look for open-source communities to find mentors.
To continue, I plan on learning more about full stack development, I also want to explore more about machine learning and AI. I can reach out to professors and other connections that I have to help me stay on path. 
